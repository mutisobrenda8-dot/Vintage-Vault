...
<section class="vv-hero">
    <div class="container">
        ...
        <a href="/vintage-vault/week1b/shop.php" class="vv-hero-btn">Explore the collection</a>
    </div>
</section>
            ...
            <div class="card vv-product-card border-0 h-100">
                ...
                <div class="vv-product-img">
                    <?php if ($product['image'] && file_exists("images/" . $product['image'])): ?>
                        <img src="/vintage-vault/week1b/images/<?= htmlspecialchars($product['image']) ?>"
                ...
                <div class="card-body d-flex flex-column p-3">
                    ...
                    <div class="mt-auto d-flex justify-content-between align-items-center">
                        ...
                        <a href="/vintage-vault/week1b/product.php?id=<?= $product['id'] ?>"
