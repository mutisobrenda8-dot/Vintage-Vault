...
<section class="vv-hero">
    <div class="container" style="position:relative;">
        ...
        <!-- Search Bar -->
        <form action="//week1-brenda/week1b//shop.php" method="GET"
        ...
        <a href="//week1-brenda/week1b//shop.php" class="vv-hero-btn"
...
<section style="background:var(--vv-parchment);
    ...
    <div class="container">
        <div style="display:flex; gap:8px;
            ...
            <a href="//week1-brenda/week1b//shop.php" class="vv-cat-pill active">
                All Items
            </a>
