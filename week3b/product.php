...
$id = $_GET['id'] ?? null;
if (!$id || !is_numeric($id)) {
    header('Location: //week1-brenda/week1b//shop.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST'
    ...
    if (!isset($_SESSION['user_id'])) {
        ...
        if ($rating < 1 || $rating > 5) {
            ...
            header("Location: //week1-brenda/week1b//product.php?id=$id");
            exit;
        }
    }
}
...
<div class="container py-5">
    ...
    <nav style="font-size:0.78rem; color:var(--vv-muted);
        ...
        <span style="margin:0 8px;">›</span>
        <a href="//week1-brenda/week1b//shop.php?category=<?= $product['category_id'] ?>"
    ...
    <div class="row g-5 mb-5">
        ...
        <div class="col-12 col-md-7">
            ...
            <?php if ($product['stock'] > 0): ?>
                ...
                <a href="//week1-brenda/week1b//cart.php"
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-4">
                <div class="card vv-product-card border-0 h-100">
                    <a href="//week1-brenda/week1b//product.php?id=<?= $rp['id'] ?>">
