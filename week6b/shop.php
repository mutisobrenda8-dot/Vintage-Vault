    ...
    <div class="col-12 col-md-3">
        <div style="background:#faf6ef; border:1px solid var(--vv-gold);
            ...
            <nav style="display:flex; flex-direction:column; gap:4px;">
                ...
                <a href="/vintage-vault/week6b/shop.php?category=<?= $cat['id'] ?>"
                   style="padding:8px 12px; font-size:0.82rem;
                          text-decoration:none;
    ...
    <div class="col-12 col-md-9">
        ...
        <?php if (empty($products)): ?>
            <div style="text-align:center; padding:60px 20px;
                ...
                <a href="/vintage-vault/week6b/shop.php" class="btn btn-vv-primary mt-3">
                    View all items
                </a>
            </div>
        <?php else: ?>
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-xl-4">
                <div class="card vv-product-card border-0 h-100">
                    <a href="/vintage-vault/week6b/product.php?id=<?= $p['id'] ?>">
