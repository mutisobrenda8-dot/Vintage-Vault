...
$id = $_GET['id'] ?? null;
if (!$id || !is_numeric($id)) {
    header('Location: /vintage-vault/week7b/shop.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST'
    ...
    if (!isset($_SESSION['user_id'])) {
        ...
        if ($rating < 1 || $rating > 5) {
            ...
            header("Location: /vintage-vault/week7b/product.php?id=$id");
            exit;
        }
    }
}
...
<div class="container py-5">
    ...
    <nav style="font-size:0.78rem; color:var(--vv-muted);
                margin-bottom:24px;">
        <a href="/vintage-vault/week7b/index.php"
           style="color:var(--vv-brown);">Home</a>
        <span style="margin:0 8px;">›</span>
        <a href="/vintage-vault/week7b/shop.php"
           style="color:var(--vv-brown);">Shop</a>
        <span style="margin:0 8px;">›</span>
        <a href="/vintage-vault/week7b/shop.php?category=<?= $product['category_id'] ?>"
    ...
    <div class="row g-5 mb-5">
        ...
        <div class="col-12 col-md-5">
            <div style="background:var(--vv-parchment);
                ...
                if ($product['image'] !== 'placeholder.jpg'
                    && file_exists($img)):
                ?>
                    <img src="/vintage-vault/week7b/<?= $img ?>"
        ...
        <div class="col-12 col-md-7">
            ...
            <?php if ($product['stock'] > 0): ?>
                ...
                <a href="/vintage-vault/week7b/cart.php"
    ...
    <div style="border-top:1px solid var(--vv-parchment);
        ...
        <?php else: ?>
            <p style="font-size:0.85rem; color:var(--vv-muted);
                      margin-bottom:24px;">
                <a href="/vintage-vault/week7b/login.php">Log in</a>
                to leave a review.
            </p>
        <?php endif; ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-4">
                <div class="card vv-product-card border-0 h-100">
                    <a href="/vintage-vault/week7b/product.php?id=<?= $rp['id'] ?>">
